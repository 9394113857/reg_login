...
def login():
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        cursor.execute("select * from accounts WHERE (username = %s )",
                    (username,))  # PATIENT_PERSONAL_DETAILS, PATIENT_SIGNUP
...
# Check if account exists using MySQL
        ...
        if account:
            ...
            cursor.execute('INSERT INTO accounts(username, password, email, firstname, lastname, phonenumber) '
                           'VALUES (%s, %s, %s, %s, %s, %s)', (username, hassedpassword, email, firstname, lastname, phonenumber))
